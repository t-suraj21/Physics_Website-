...
import { User, Mail, Lock, Phone, GraduationCap, Atom, Milestone, FileText, Star } from 'lucide-react';
...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const result = await register(name, email, password, phone, className);
    setLoading(false);
  ...
  return (
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-12 bg-white dark:bg-slate-955 dark:bg-slate-950 transition-colors duration-200">
      ...
      <div className="hidden lg:flex lg:col-span-7 bg-slate-950 relative overflow-hidden flex-col justify-between p-12 border-r border-slate-900">
        ...
        <div className="space-y-8 max-w-xl my-auto z-10 text-left">
          ...
          <h2 className="text-4xl sm:text-5xl font-black tracking-tight uppercase leading-[1.1] text-white">
            Unlock Your <br />
            Problem Solving <br />
            <span className="bg-gradient-to-r from-primary-400 via-primary-500 to-accent-400 bg-clip-text text-transparent">Potential</span>
          </h2>
          
          <p className="text-sm text-slate-400 leading-relaxed font-semibold">
            Register for a student account to view expert video playlists, download detailed PDF notes, upload homework assignments, and participate in graded mock exams.
          </p>

          {/* Core Selling Points */}
          <div className="space-y-4 pt-2">
            {[
              { icon: FileText, title: 'Revision & Homework Workspace', desc: 'Download worksheets and upload your solved tasks directly for grading.' },
              { icon: Milestone, title: 'MCQ Assessment Engines', desc: 'Real-time online tests covering mechanics, magnetism, and wave optics.' }
            ].map((pt, idx) => {
              const Icon = pt.icon;
              return (
        ...
        <div className="pt-8 border-t border-slate-900 z-10 text-left">
          ...
          <p className="text-xs italic text-slate-400 font-medium leading-relaxed">
            "I went from memorizing formulas blindly to intuitively drawing free-body diagrams in two weeks. The step-by-step lecture walkthroughs are incredibly helpful!"
          </p>
          <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest mt-2">
            &mdash; Priya Sen, 11th Grade Student
          </p>
        </div>
      </div>
      ...
      <div className="lg:col-span-5 flex flex-col justify-between p-8 sm:p-12 relative">
        ...
        {/* Form Container */}
        <div className="w-full max-w-md mx-auto space-y-6 my-auto text-left">
            ...
            <div className="space-y-1">
              ...
              <div className="relative rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/50 focus-within:border-slate-900 dark:focus-within:border-white transition-all">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-4 py-2.5 bg-transparent text-slate-900 dark:text-slate-100 placeholder-slate-400 text-sm focus:outline-none focus:ring-0 border-0"
                />
              </div>
            </div>
              ...
              <div className="space-y-1">
                ...
                <div className="relative rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/50 focus-within:border-slate-900 dark:focus-within:border-white transition-all">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-2 py-2 bg-transparent text-slate-900 dark:text-slate-100 placeholder-slate-400 text-sm focus:outline-none focus:ring-0 border-0"
                  />
                </div>
              </div>
              ...
              <div className="space-y-1">
                ...
                <div className="relative rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/50 focus-within:border-slate-900 dark:focus-within:border-white transition-all">
                  ...
                  <select
                    ...
                    className="w-full pl-10 pr-4 py-2.5 bg-transparent text-slate-900 dark:text-slate-100 text-sm focus:outline-none focus:ring-0 border-0 cursor-pointer appearance-none"
                  >
                    <option value="9th" className="bg-white dark:bg-slate-900 text-slate-900 dark:text-white">9th Grade</option>
                    <option value="10th" className="bg-white dark:bg-slate-900 text-slate-900 dark:text-white">10th Grade</option>
                    <option value="11th" className="bg-white dark:bg-slate-900 text-slate-900 dark:text-white">11th Grade</option>
                    <option value="12th" className="bg-white dark:bg-slate-900 text-slate-900 dark:text-white">12th Grade</option>
                    <option value="B.Sc" className="bg-white dark:bg-slate-900 text-slate-900 dark:text-white">B.Sc Physics</option>
                  </select>
                </div>
              </div>
            </div>
          ...
          <div className="pt-4 border-t border-slate-100 dark:border-slate-900 text-center">
            <p className="text-xs text-slate-550 dark:text-slate-400 font-semibold">
              ...
              <Link to="/login" className="text-slate-950 dark:text-white hover:underline transition-all">
                Sign In
              </Link>
            </p>
          </div>
